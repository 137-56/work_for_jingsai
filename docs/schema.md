...
[
  {
    ...
    "dynasty": "清",
    "carrier": ["瓷器", "织锦", "建筑装饰"],
    "meaning": "清廉、圣洁；谐音「连」，寓意连绵不绝",
    "occasion": ["春节", "婚庆", "寿诞"],
    "elements": ["缠枝", "莲花", "卷草"],
    "source": "故宫博物院数字文物库",
    "source_url": "https://digicol.dpm.org.cn/detail/108723",
    "license": "公版 / Open Data",
    "image_path": "data/images/GUGONG-108723.jpg",
    "phash": "e1c9a8b7c6d5e4f3",
    "clip_vec_index": 0
  }
]
```
...
| `dynasty` | string | ✅ | 朝代 | 如「清」「唐」「宋」；不详写「不详」 |
...
| `source` | string | ✅ | 来源机构 | 如「故宫博物院数字文物库」 |
| `source_url` | string | ✅ | 出处链接 | **完整可用、不截断** |
| `license` | string | ✅ | 授权类型 | **红线相关，不得为空**；公版 / CC BY-NC 4.0 / 官方开放 等如实填写 |
...
**`carrier` 允许值：**
```
瓷器 / 织锦 / 刺绣 / 家具 / 屏风 / 建筑装饰 / 建筑彩画 / 石雕 / 木雕 / 服饰 / 壁画 / 漆器 / 玉器 / 金银器 / 剪纸 / 民俗装饰
```
